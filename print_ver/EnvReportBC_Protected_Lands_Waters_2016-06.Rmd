...
* For terrestrial areas/inland water, the protected areas are comprised of `r land_ppa$cum_p_type`% PPAs and `r land_oecm$cum_p_type`% OECMs. 
* Coastal areas in B.C. are comprised of `r water_ppa$cum_p_type`% PPAs and `r water_oecm$cum_p_type`% OECMs.
* The amount of protected land and water varies across B.C. The distribution is shown below by terrestrial/marine ecoregion and by ecosystem. 
...
### Trends in the Protection of British Columbia's Terrestrial Ecoregions (1886-2020)

The interactive map below shows how much land is protected within each of B.C.'s 44 [terrestrial ecoregions](http://www.env.gov.bc.ca/ecology/ecoregions/). Ecoregions are areas with similar climate and geologic features. 
...
-   Ecosystems in British Columbia are characterized as [biogeoclimatic
    zones](https://www.for.gov.bc.ca/hre/becweb/) - geographic areas with
