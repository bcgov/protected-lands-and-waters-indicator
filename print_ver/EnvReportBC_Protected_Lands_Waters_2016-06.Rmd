...
#### stopped here loading files next part

tar_load(ecoregion_totals)
tar_load(total_prot_area)
tar_load(pa_eco_sum)
...
* **As of 2020, protected lands and water cover `r land_ppa$cumulative_by_type + land_oecm$cumulative_by_type`% of B.C.'s terrestrial areas and inland water and `r water_ppa$cumulative_by_type + water_oecm$cumulative_by_type`% of coastal and marine areas.** 
* For terrestrial areas/inland water, the protected areas are comprised of `r land_ppa$cumulative_by_type`% PPA and `r land_oecm$cumulative_by_type`% OECM. 
* Coastal areas in B.C. are comprised of `r water_ppa$cumulative_by_type`% PPA and `r water_oecm$cumulative_by_type`% OECM.
* To update: 
