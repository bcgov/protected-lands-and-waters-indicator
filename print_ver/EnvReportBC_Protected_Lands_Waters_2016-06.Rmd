...
targets::tar_load(c(ecoregion_totals, total_prot_area, pa_eco_sum))
```
...
* **As of 2020, protected lands and water cover % of B.C.'s terrestrial areas and inland water and % of coastal and marine areas.** PA and OECM breakdown here. 
* To update: 
