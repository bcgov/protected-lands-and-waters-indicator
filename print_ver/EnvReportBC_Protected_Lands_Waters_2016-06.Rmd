...
* **As of 2020, protected lands and water cover `r land_total`% of B.C.'s terrestrial areas and inland water and `r water total`% of coastal and marine areas.**
* For terrestrial areas/inland water, the protected areas are comprised of `r land_ppa$summary_total`% PPAs and `r land_oecm$summary_total`% OECMs.
* Coastal areas in B.C. are comprised of `r water_ppa$summary_total`% PPAs and `r water_oecm$summary_total`% OECMs.
