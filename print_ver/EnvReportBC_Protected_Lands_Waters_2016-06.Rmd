...
land_total <- round(land_ppa$cum_p_type + land_oecm$cum_p_type, digits=1)

water_total <- round(water_ppa$cum_p_type + water_oecm$cum_p_type, digits=1)
```
...
-   For terrestrial areas/inland water, the protected areas are
    comprised of `r land_ppa$cum_p_type`% PPAs and
    `r land_oecm$cum_p_type`% OECMs.
-   Coastal areas in B.C. are comprised of `r water_ppa$cum_p_type`%
    PPAs and `r water_oecm$cum_p_type`% OECMs.
