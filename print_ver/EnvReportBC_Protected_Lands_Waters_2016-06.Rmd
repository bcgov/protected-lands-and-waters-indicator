...
Protected lands and waters are legally established areas set aside to conserve nature and cultural values. Canada adopted [UN Conventional on Biological Diversity targets](https://www.cbd.int/sp/targets/rationale/target-11/) to protect at least 17% of terrestrial areas and inland water and 10% of coastal and marine areas by 2020, which Canada has since extended until 2023 [(Pathway to Canada Target 1)](https://www.conservation2020canada.ca/home). British Columbia's network of protected areas and other effective area-based conservation measures contribute to the Canadian, and global targets. 
